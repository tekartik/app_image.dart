...
class _MainPageState extends State<MainPage> {
  ...
  final _ovalCropMask = ValueNotifier<bool>(
    prefs.getBool('ovalCropMask') ?? false,
  );
  final _ovalCropInPreview = ValueNotifier<bool>(
    prefs.getBool('ovalCropInPreview') ?? true,
  );
                            ...
                            child: ValueListenableBuilder<bool>(
                              ...
                              builder: (context, ovalCropMask, _) {
                                return ValueListenableBuilder<bool>(
                                  ...
                                  builder: (context, ovalCropInPreview, _) {
                                    ...
                                    if (ovalCropInPreview && ovalCropMask) {
